...
pub fn run () -> opencv::Result<()> {
    ...
    let face_detector_name : &str = "C:/tools/opencv/sources/data/haarcascades/haarcascade_frontalface_alt.xml";
    let eyes_detector_name : &str = "C:/tools/opencv/sources/data/haarcascades/haarcascade_eye_tree_eyeglasses.xml";
